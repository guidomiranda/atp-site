...
import { createBanner, getBanner, updateBanner } from '../../../utils';
import { FileType } from '../../../interfaces/image';
import { useImage } from '../../../hooks/useImage';

const BannerAdminCreate = () => {
	...
	const handleUpdateSuccessInfo = async () => {
		if (image) {
			...
			const response = await createBanner(bannerInfoUpdated);
...
export default BannerAdminCreate;
