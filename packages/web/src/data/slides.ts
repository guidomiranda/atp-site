export const slides_data = [
	{
		...
		bg: 'https://res.cloudinary.com/https-atp-com-py/image/upload/v1657234402/background_testimonios_wdsozv.jpg',
		description: [
			'Contamos con un equipo enfocado en brindarte la mejor atención, atención de calidad.',
	...
	// 	bg: 'https://res.cloudinary.com/https-atp-com-py/image/upload/v1657234402/background_testimonios_wdsozv.jpg',
	// 	description: [
	// 		'Cada problema necesita una solución diferente, igual que nuestros productos, todos tienen una característica especial que los diferencia de los demás.',
